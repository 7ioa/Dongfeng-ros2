...
preview_dir=workspace/'previews/vehicle'
...
data=(preview_dir/'vehicle-data.json').read_text(encoding='utf-8')
...
(preview_dir/'index.html').write_text(text,encoding='utf-8')
